...
<!-- 左侧内容 -->
<div class="ct_header">
  <el-button type="primary" @click='addBanner'>添加软文</el-button>
</div>
...
export default {
  ...
  created() {
    ...
    this.axios
      .post(
        "http://192.168.1.52:8765/api/search-service/recipeArticle/list?token=" +
          this.tokenprops,
        {}
      )
      .then(response => {
    ...
    handleDelete(index, row) {
      this.$confirm("此操作将永久删除该软文, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          this.axios
            .delete(
              "http://192.168.1.52:8765/api/cms-service/recipeArticle/delete?token=" +
                this.tokenprops +
                "&id=" +
                row.id,
              {}
