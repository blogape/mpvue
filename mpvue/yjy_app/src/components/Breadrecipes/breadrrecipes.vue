...
import Recipefood from "./recipefood/recipefood.vue";
export default {
  data() {
    return {
      selected: "1",
  ...
  methods: {
    brerecipe() {
      var _this = this;
      this.Ajax.get(
        "http://192.168.1.52:8765/api/search-service/es/keyword?token=666666&size=20&mobileSn=H873457865H9L&keyword=%E9%9D%A2%E5%8C%85%E6%9C%BA&option=1"
      )
